...
describe Harvester::Workweek do
  context 'standard' do
    subject { Harvester::Workweek.new [8,8,8,8,8,0,0] }
    expect_week({
      total:40,
      regular:40,
      overtime:0,
  ...
  context 'worked on Saturday' do
    subject { Harvester::Workweek.new [8,8,8,8,8,8,0] }
    expect_week({
      total:48,
      regular:40,
      overtime:8,
  ...
  context 'worked on Saturday and Sunday' do
    ...
    subject { Harvester::Workweek.new [8,8,8,8,8,8,8] }
    expect_week({
      total:56,
      regular:40,
      overtime:16,
